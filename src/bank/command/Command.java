...
public abstract class Command
{
    ...
    public static Command parse(String input)
    {
    		...
    		switch( tokens[0] ){
    			...
    			case CommandCreateAccount.NAME: 		commandToReturn = createAccount( Integer.parseInt(tokens[1]) );
    												return commandToReturn;
    			case CommandDeleteAllAccounts.NAME:	commandToReturn = deleteAllAccounts();
    												return commandToReturn;
    			case CommandDeposit.NAME: 			commandToReturn = deposit( Integer.parseInt(tokens[1]), Long.parseLong(tokens[2]) );
    												return commandToReturn;
    			case CommandTotalBalances.NAME:		commandToReturn = totalBalances();
    												return commandToReturn;
    			case CommandTransfer.NAME:			commandToReturn = transfer( Integer.parseInt(tokens[1]), Integer.parseInt(tokens[2]), Long.parseLong(tokens[3]) );
    												return commandToReturn;
    			default: 							return null;
    		}
    }
